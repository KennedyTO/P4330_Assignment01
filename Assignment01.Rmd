...
-   W = Sum of SE²t / m *\*I don't know [how to get the Sum of SE²t]{.underline}*
...
d_Sto_Imp <- mice(master_d, method = "norm.nob", m = 1000, printFlag = FALSE)
m_Sto_Imp <- complete(d_Sto_Imp)
```
