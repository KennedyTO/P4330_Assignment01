...
library(negligible)
neg.reg(formula = SATQ ~ age + gender + interaction, data = d03, predictor = interaction, eil = -2, eiu = 2)

```

The lower bound of the negligible effect is -3.17 and the upper bound of the negligible effect is -0.13. Therefore, the interaction is not equivalent and statistically different.
